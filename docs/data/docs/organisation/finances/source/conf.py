...
htmlhelp_basename = 'WaveInvestorLenderdoc'
...
latex_documents = [
    (master_doc, 'WaveInvestorLender.tex', u'Wave® Financials',
...
man_pages = [
    (master_doc, 'WaveInvestorLender', u'WaveOS™ Financials',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WaveInvestorLender', u'WaveOS™ Investment & Lending',
     author, 'WaveInvestorLender', 'Free Energy & Internet',
     'Miscellaneous'),
]
